...
if ( function_exists( 'wp_nav_menu') ) {
	...
	register_nav_menus( array( 'top-menu' => __( 'Top Menu', 'woothemes' ) ) );
        register_nav_menus( array( 'top-left-menu' => __( 'Top Menu Left', 'woothemes' ) ) );
        register_nav_menus( array( 'top-right-menu' => __( 'Top Menu Right', 'woothemes' ) ) );
        register_nav_menus( array( 'foot-menu' => __( 'Top Menu', 'woothemes' ) ) );
}
